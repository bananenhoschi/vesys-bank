...
public interface BankDriver {
    ...
    /**
     * Connects to an implementation of a bank. Parameters which designate e.g. the
     * name or number of the server and possibly other arguments may be passed.
     * 
     * @param args
     ...
     * invoked, connect must be called. getBank must have singleton semantics, i.e.
     * it should return the same instance upon subsequent calls. After disconnect
     * has been called getBank returns null.
     * 
