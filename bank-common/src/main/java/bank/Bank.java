...
public interface Bank {
     ...
     * the generated account or <code>null</code>, in case that the account could
     * not be generated. An owner may own several accounts.
     * 
     * @param owner
     *            name of the owner
     * 
     ...
     * <code>false</code>. As result, the method returns whether the account could
     * be closed or not.
     * 
     * @param number
    ...
    /**
     * Returns a particular account given the account number. If the account number
     * is not valid, <code>null</code> is returned as result. The returned account
     * may be passive.
     * 
     * @param number
     *            number of the account
     * @return account with the account number as specified or <code>null</code>, if
     *         such an account was never created and does not exist.
     * @throws IOException
     *             if a remoting or communication problem occurs
     */
