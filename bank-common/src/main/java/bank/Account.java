...
public interface Account extends Serializable{
	...
	/**
	 * Returns the balance of the account. The balance of an account which has been
	 * closed is always zero. An <code>InactiveException</code> is never thrown when
	 * the balance is accessed.
	 * 
